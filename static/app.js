...
function renderNav(active, user) {
  const GROUPS = [
    ...
    { label: "Government",  items: [["/government","Cabinet"], ["/ministries","Ministries"], ["/cabinet","Cabinet Powers"], ["/legislature","Legislature"], ["/gazette","Gazette"], ["/constitution","Constitution"], ["/timeline","National Timeline"], ["/pens","The Armoury"], ["/court","Courts"], ["/fir","Report a Crime"], ["/voting","Elections"], ["/foreign","Foreign Affairs"], ["/treasury","Treasury"], ["/admin","Admin Panel"]] },
    { label: "Community",   items: [["/search","Search"], ["/citizens","Citizens"], ["/chat","Chat"], ["/videos","Videos"], ["/blogs","Blogs"], ["/flightsim","Flight Sim"], ["/casino","Casino"], ["/packet","Card Packets"], ["/cyvalend","Cyvalend"], ["/sites","Citizen Sites"], ["/ai","Cyvathon AI"], ["/invite","Invite Friends"], ["/news","News"], ["/rules","Rules"]] },
    { label: "ID Card", items: [["/profile","ID Card"], ["/passport","Passport & Citizenship"], ["/portfolio","Portfolio"], ["/leaderboard","Leaderboards"], ["/wrapped","Wrapped"]] },
  ];
