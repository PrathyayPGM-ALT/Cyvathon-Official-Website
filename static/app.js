...
function renderNav(active, user) {
  const GROUPS = [
    ...
    { label: "Government",  items: [["/government","Cabinet"], ["/ministries","Ministries"], ["/cabinet","Cabinet Powers"], ["/legislature","Legislature"], ["/gazette","Gazette"], ["/pens","The Armoury"], ["/court","Courts"], ["/fir","Report a Crime"], ["/voting","Elections"], ["/foreign","Foreign Affairs"], ["/treasury","Treasury"], ["/admin","Admin Panel"]] },
