...
function renderNav(active, user) {
  const GROUPS = [
    ...
    { label: "Community",   items: [["/citizens","Citizens"], ["/leaderboard","Leaderboards"], ["/chat","Chat"], ["/ai","Cyvathon AI"], ["/portfolio","Portfolio"], ["/invite","Invite Friends"], ["/news","News"], ["/rules","Rules"]] },
