...
def _security_headers(resp):
    ...
    resp.headers["Content-Security-Policy"] = (
        ...
        # blob: lets theme music play songs a citizen keeps in their own browser.
        # Only this site's scripts can make a blob: URL, so it opens nothing to others.
...
def create_poll():
    ...
    position = data.get("position", "Chancellor").strip() or "Chancellor"
